# Generated by Django 2.1.2 on 2018-10-14 16:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='dataset',
            name='distribution',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cataloger.Distribution'),
        ),
        migrations.AddField(
            model_name='dataset',
            name='keywords',
        ...
        migrations.AddField(
            model_name='dataset',
            name='language',
            field=models.ManyToManyField(blank=True, to='cataloger.Language'),
        ),
        migrations.AddField(
            model_name='dataset',
            name='license',
            field=models.ForeignKey(default=2, on_delete=django.db.models.deletion.PROTECT, to='cataloger.License'),
        ),
        migrations.AddField(
            model_name='dataset',
            name='programCode',
        ...
        migrations.AddField(
            model_name='dataset',
            name='schema',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cataloger.Schema'),
        ),
        migrations.AddField(
            model_name='profile',
            name='bureau',
