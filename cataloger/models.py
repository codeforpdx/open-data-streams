...
class Dataset(models.Model):
    ...
    language = models.ManyToManyField(Language, blank=True, default=57, help_text='To select multiple languages, use <b>CTRL + Click</b> on Windows or <b>CMD + Click</b> on MacOS.')
